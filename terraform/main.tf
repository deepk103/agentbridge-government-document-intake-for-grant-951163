...
resource "aws_vpc" "main" {
  ...
  tags = {
    blueprint = "Government Document Intake for Grant"
    environment = "production"
    Name = "agentbridge-government-document-intake-for-grant"
    Environment = "production"
    ManagedBy = "terraform"
  }
}
...
resource "aws_internet_gateway" "main" {
  ...
  tags = {
    Name = "agentbridge-government-document-intake-for-grant-igw"
  }
}
...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "agentbridge-government-document-intake-for-grant-public"
  }
}
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "agentbridge-government-document-intake-for-grant-rt"
  }
}
...
resource "aws_security_group" "main" {
  name_prefix = "agentbridge-government-document-intake-for-grant-"
  vpc_id      = aws_vpc.main.id
  ...
  tags = {
    Name = "agentbridge-government-document-intake-for-grant-sg"
  }
...
resource "aws_key_pair" "deploy" {
  ...
  key_name   = "agentbridge-government-document-intake-for-grant"
...
resource "aws_eip" "main" {
  ...
  domain   = "vpc"
  tags = {
    Name = "agentbridge-government-document-intake-for-grant-eip"
  }
}
...
resource "aws_ebs_volume" "data" {
  ...
  encrypted         = true
  tags = {
    Name = "agentbridge-government-document-intake-for-grant-data"
  }
}
...
resource "aws_iam_role" "bedrock_flow" {
  ...
  name  = "agentbridge-government-document-intake-for-grant-bedrock-role"
...
resource "aws_iam_role" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-government-document-intake-for-grant-ec2-bedrock"
...
resource "aws_iam_instance_profile" "ec2_bedrock" {
  count = var.enable_bedrock ? 1 : 0
  name  = "agentbridge-government-document-intake-for-grant-ec2-profile"
...
resource "aws_bedrockagent_flow" "main" {
  count              = var.enable_bedrock ? 1 : 0
  name               = "agentbridge-government-document-intake-for-grant-flow"
